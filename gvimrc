...
"  set guifont=Menlo:h50 "Osaka-Mono:h40
"elseif has('mac')
...
"---------------------------------------------------------------------------
" C-F12を押す毎に透過度を変える
nnoremap <expr><C-F12> &transparency+40 >= 50 ? ":set transparency=0\<CR>" : ":let &transparency=&transparency+40\<CR>"

if has('gui_macvim')
    set transparency=3
    "set guifont=Menlo:h12
 	set gfn=Ricty\ Discord\ Regular:h11
    set guioptions-=T
endif
